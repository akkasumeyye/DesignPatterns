...
namespace Multiton // belli sarta göre instance üretip, gercekten o sartı saglayan istekler icin o instance verilmesidir. 100 istekte farklı nesneleri uretip kullanırız
{
    ...
    class Camera
    {
        static Dictionary<string, Camera> _cameras = new Dictionary<string, Camera>();// birden fazla instance olacagı icin dictionary
