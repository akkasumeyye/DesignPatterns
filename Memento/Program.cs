...
namespace Memento // hafızadan gelir, nesne degısıklıge ugradıktan sonra arzu edersek degısıklıge ugramadan devam eder
{
    ...
    class Book
    {
        ...
        {
            Console.WriteLine("{0},{1},{2} edited: {3}", Isbn,Author,Title,_lastEdited);
        }
    }
    class Memento
    {
